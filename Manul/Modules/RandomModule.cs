...
namespace Manul.Modules
{
    public class RandomModule : ModuleBase<SocketCommandContext>
    {
        ...
        private static readonly string[] HandThings =
        {
            ...
            "квас 0.3", "книга рецептов Совуньи", "бумажная мысль", "амнезия", "смешной мем", "несмешной мем",
            "право не заходить в голосовой канал 1 час", "ссылка на Webinar", "рисунок танка", "деструктивный мемагент",
            "карась", "плитка шоколада", "автомат по любому предмету", "бесплатная консультация по WoT",
            "платная консультация по WoT", "премиум аккаунт в Miodenus Project", "RTX 3090", "ПЧЁЛЫ", "лапка кота",
            "огурец от Копатыча", "шашлы4ok", "пробитие", "проблемы", "много проблем", "сверх много проблем", "подушка",
            "холодильник"
        };
