...
public class RandomModule : ModuleBase<SocketCommandContext>
{
    ...
    private static readonly string[] HandThings =
    {
        ...
        "плюшевый манул", "абонемент в киберспортзал на два дня", "+5 к удаче", "клоунский нос", 
        "самоучитель по клоунаде", "трагедия", "бесплатная доставка", "фкутный бургер", "дачный сезон", "конфетька",
        "ботинок Саныча", "радостное мяуканье", "чай с баранками", "немножечко варенья", "мое увожение", 
        "от винта бассбустед", "мерч манула", "ай, не придумал я", "мармеладька", "ответы на все задания в этом семе",
        "сборник анекдотов (коллекционное издание)", "мерч МАИ", "тема диплома, получить можно на сайте балабобы",
        "функциональная схема предприятия", "удача на даче", "новый телефон4ик", "нерабочий код", "рабочий код", 
        "задание от Семенова", "докладная записка от Прудникова", "потерянный журнал", "нерозданные студаки", 
        "зачет автоматом по \"мануловедению\"", "тест на 100%", "абстрактный класс", 
        "шютька от Саныча, за получением обращаться в его Telegram", "фан-встреча", "асус бабабук", 
        "рекламная интеграция от имба энерджи", "новый выпуск передачи \"Утренний Прудников\"", "робопес", 
        "кисадмин из мурмяунцево", "работы предыдущих курсов", "PayStation 5", 
        "топ 5 причин перенести все дела на завтра"
    };
