...
public class MyDreamsModule : SecretModule
{
    ...
    public MyDreamsModule() : base(
            ...
            answers: new []
            {
                ...
                "**Поздравляем! Мы готовы предложить вам неоплачиваемую бесконечную стажировку в компании \"Miodenus Project MLG Team\" без последующего трудоустройства. Если согласны - напишите манулу в Telegram**"
            }) {}
